...
const visualCss = fs.readFileSync(path.join(rootDir, "public/css/12-visual-polish.css"), "utf8");
const packageJson = JSON.parse(fs.readFileSync(path.join(rootDir, "package.json"), "utf8"));

assert(cssEntry.includes('@import url("/css/12-visual-polish.css");'), "styles.css must import visual polish module");
