...
const canvasRoot = join(appDir, "..");
const repoRoot = join(canvasRoot, "..", "..");
const srcDir = join(canvasRoot, "src");
const publicDir = join(repoRoot, "public", "canvas-v2");
...
console.log(`[canvas-v2-build] wrote public/canvas-v2 with ${mainFile} and ${cssFile}`);
...
function renderIndex({ mainFile, cssFile }) {
  return `<!doctype html>
<html lang="zh-CN" data-app="canvas-v2" data-density="compact">
  <head>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="robots" content="noindex">
    <title>Canvas v2 | ai-image-studio</title>
    ...
    <link rel="stylesheet" href="/canvas-v2/assets/${cssFile}">
  </head>
  <body data-app="canvas-v2">
    <div data-canvas-v2-root>
      <main class="canvas-v2-shell" data-status="booting">
        <h1>Canvas v2</h1>
        <p>正在初始化画布工作台...</p>
      </main>
    </div>
    <script type="module" src="/canvas-v2/assets/${mainFile}"></script>
  </body>
</html>
`;
}
