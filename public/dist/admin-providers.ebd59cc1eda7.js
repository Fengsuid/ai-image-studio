(function(){window.AdminModules=window.AdminModules||{},window.AdminModules.providers={render({state:d,helpers:e}){const{escapeHtml:t,renderPlaceholder:s}=e;return`
              ...
              <tbody>
                ${d.providers.map(a=>`
                  <tr>
                    ...
                    <td class="admin-truncate">${t(n(a))}</td>
        ...
        ${s("Provider Router 预留","ri-route-line",["T019 将把生成和编辑接口改为 provider-router。","当前 T018 已提供 provider_configs、CRUD、测试连接和默认供应商。"])}`}};function n(d){const e=d.capabilities||{};return Object.entries(e).filter(([,t])=>t===!0).map(([t])=>t).join(", ")||"-"}})();
